...
func getMoviesGenres(forGenre genre: String) -> [MovieElement] {
    // Filter movies based on the genre string
    var moviesArray : [MovieElement] = []
    if let path = Bundle.main.path(forResource: "movies", ofType: "json") {
        ...
        let filteredMovies = moviesArray.filter { movie in
            // Ensure genres array is not nil and contains the specified genre
...
// Assuming Genre is a custom type
//struct Genre {
//    let name: String
//}

// Conform Genre to CustomStringConvertible
